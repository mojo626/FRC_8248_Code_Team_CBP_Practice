...
public class DrivetrainSubsystem extends SubsystemBase {
    ...
    public void drive(double turn, double forward, double scaling, JoystickScaling joystickStyle, double driveMultiplier, DriveStyle driveType) {
        drivetrain.pickDrivetrain(turn, forward, driveMultiplier, joystickStyle, scaling, driveType);
    }
