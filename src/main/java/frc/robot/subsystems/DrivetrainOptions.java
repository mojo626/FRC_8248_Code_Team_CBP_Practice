...
public class DrivetrainOptions extends RobotDriveBase {
    ...
    public void pickDrivetrain(double turnSpeed, double forwardSpeed, double speedMultiplier, JoystickScaling scaleType, double curveScaling, DriveStyle driveStyle) {
